                            ...
                            <div class="header__top-content--right">
                                <div class="user-info user-set-role">
                                    <a class="user-set-role__button" href="#" data-toggle="dropdown"
                                       aria-haspopup="true">Setting <i class="fal fa-chevron-down"></i></a>
                                ...
                                <div class="user-currency user-set-role">
                                    <a class="user-set-role__button" href="#" data-toggle="dropdown"
                                       aria-haspopup="true">USD $<i class="fal fa-chevron-down"></i></a>
                                    <ul class="expand-dropdown-menu dropdown-menu">
                                        <li><a href="#">USD $</a></li>
                                        <li><a href="#">EURO €</a></li>
                                    </ul>
                                ...
                                <div class="user-info user-set-role">
                                    ...
                                    <ul class="expand-dropdown-menu dropdown-menu">
                                        ...
                                        <li><a href="#"><img src="assets/img/icon/flag/icon_france.png" alt=""> Français</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <ul class="header__nav">
                            ...
                            <li class="header__nav-item pos-relative">
                                ...
                                <ul class="dropdown__menu pos-absolute">
                                    <li class="dropdown__list"><a href="index.html" class="dropdown__link">Home 1</a>
                                    </li>
                                    <li class="dropdown__list"><a href="index-2.html" class="dropdown__link">Home 2</a>
                                    </li>
                                    <li class="dropdown__list"><a href="index-3.html" class="dropdown__link">Home 3</a>
                                    </li>
                                    <li class="dropdown__list"><a href="index-4.html" class="dropdown__link">Home 4</a>
                                    </li>
                                </ul>
                                <!--Single Dropdown Menu-->
                            ...
                            <li class="header__nav-item pos-relative">
                                ...
                                <!--Single Dropdown Menu-->
                                <ul class="dropdown__menu pos-absolute">
                                    <li class="dropdown__list"><a href="about.html" class="dropdown__link">About</a>
                                    </li>
                                    ...
                                    <li class="dropdown__list"><a href="compare.html" class="dropdown__link">Compare</a>
                                    </li>
                                    <li class="dropdown__list"><a href="empty-cart.html" class="dropdown__link">Empty
                                            Cart</a></li>
                                    <li class="dropdown__list"><a href="wishlist.html"
                                                                  class="dropdown__link">Wishlist</a></li>
                                    <li class="dropdown__list"><a href="my-account.html" class="dropdown__link">My
                                            Account</a></li>
                                    <li class="dropdown__list"><a href="login.html" class="dropdown__link">Login</a>
                                    </li>
                                    <li class="dropdown__list"><a href="404-page.html" class="dropdown__link">404
                                            Page</a></li>
                                </ul>
                                <!--Single Dropdown Menu-->
                            </li> <!-- End Single Nav link-->
                                        ...
                                        <div class="mega-menu__item-box">
                                            ...
                                            <ul class="mega-menu__item">
                                                <li class="mega-menu__list"><a href="shop-list.html"
                                                                               class="mega-menu__link">Shop List</a>
                                                </li>
                                        ...
                                        <div class="mega-menu__item-box">
                                            ...
                                            <ul class="mega-menu__item">
                                                ...
                                                <li class="mega-menu__list"><a href="single-right-tab.html"
                                                                               class="mega-menu__link">Right Tab</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--Single Megamenu Item Menu-->
                                ...
                                <ul class="mega-menu pos-absolute">
                                    <li class="mega-menu__box">
                                        ...
                                        <div class="mega-menu__item-box">
                                            ...
                                            <ul class="mega-menu__item">
                                                <li><p>Shop Women Is Clothing And Accessories And Get Inspired By The
                                                        Latest Fashion Trends.</p></li>
                                            </ul>
                                        </div>
                                        <!--Single Megamenu Item Menu-->
                                        ...
                                        <div class="mega-menu__item-box">
                                            ...
                                            <ul class="mega-menu__item">
                                                <li><p>A New Flattering Style With All The Comfort Of Our Linen.</p>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--Single Megamenu Item Menu-->
                                        ...
                                        <div class="mega-menu__item-box">
                                            ...
                                            <ul class="mega-menu__item">
                                                <li><p>Endless Styling Possibilities In A Collection Full Of Versatile
                                                        Pieces.</p></li>
                                            </ul>
                                        </div>
                                        <!--Single Megamenu Item Menu-->
                                    ...
                                    <li class="dropdown__list">
                                        ...
                                        <ul class="dropdown__submenu pos-absolute">
                                            <li class="dropdown__submenu-list"><a href="blog-grid-left-sidebar.html"
                                                                                  class="dropdown__submenu-link"> Blog
        ...
        <ul class="offcanvas-add-cart__menu">
            ...
            <li class="offcanvas-add-cart__list pos-relative">
                ...
                <div class="offcanvas-add-cart__detail">
                    <a href="single-1.html" class="offcanvas-add-cart__link">PlayStation 4 Pro 1TB Star Wars Battlefront
                        II Bundle</a>
