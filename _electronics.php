            ...
            <div class="col-12">
                <div class="section-content section-content--border d-md-flex align-items-center justify-content-between">
                    ...
                    <ul class="product__extra-nav nav">
                        <li><a class="nav-link" href="shop-1.html">Toys & Hobbies</a></li>
                        <li><a class="nav-link" href="shop-1.html">Sports & Outdoors</a></li>
                        <li><a class="nav-link" href="shop-1.html">Smartphone & Tablets</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="swiper-outside-arrow-fix pos-relative">
                    <div class="product-default-slider-5grid-2row overflow-hidden  m-t-50">
